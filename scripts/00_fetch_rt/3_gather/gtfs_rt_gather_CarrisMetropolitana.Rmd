...
output_folder = "../data/cmet_20260413_220260430_business_a4"
agency_id = "44" # None 
...
def process_json(data, filename, RECORDS):
    ...
    for e in data:
        ...
        if 'trip_id' not in vehicle:
            continue
        if agency_id and 'agency_id' in vehicle and vehicle['agency_id'] != agency_id:
            continue
...
with open(f'{output_folder}/updates.csv', 'w') as csv_file:  
    ...
    _ = writer.writerow(["trip_id", "route_id", "timestamp", "timestamp_formatted", "lat", "lon", "speed", "stop_id", "current_status"])
