...
csv_file = open(f'{output_folder}/updates_2.csv', 'w') 
with open(f'{output_folder}/updates_2.csv', 'w') as csv_file:  
    writer = csv.writer(csv_file)
    _ = writer.writerow(["trip_id", "route_id", "timestamp", "timestamp_formatted", "lat", "lon", "speed", "stop_seq"], )
    for trip, data in RECORDS.items():
