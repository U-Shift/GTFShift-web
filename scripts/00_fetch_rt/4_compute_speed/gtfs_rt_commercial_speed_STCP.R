...
# Run with: $ Rscript 00_fetch_rt/4_compute_speed/gtfs_rt_commercial_speed_STCP.R > data/stcp_20260413_220260430_business/processing_speed_shape_distance/gtfs_rt_commercial_speed.log 2>&1

# > STCP, Porto, Portugal 
UPDATES_RAW_FOLDER = "data/stcp_20260413_220260430_business/processing_speed_shape_distance"
