...
regions <- bind_rows( # CarrisMetropolitana, Area 3
  ...
  data.frame(
    ...
    rt_interval = "13-30/04/2026 (Business Days)",
    rt_collection = I(list("data/cmet_20260413_220260430_business_a3/updates.csv")),
    rt_collection_manipulate = I(list(function(df) {
      df |>
        mutate(
          speed = as.numeric(speed)
...
regions <- bind_rows( # Barreiro
  ...
  data.frame(
    ...
    rt_collection = I(list("data/barreiro_20260511_20260515/updates.csv")),
    rt_collection_manipulate = I(list(function(df) {
      df |>
        mutate(
          speed = as.numeric(speed)
...
regions <- bind_rows( # STCP
  ...
  data.frame(
    ...
    rt_interval = "13-30/04/2026 (Business Days)",
    rt_collection = I(list("data/stcp_20260413_220260430_business/updates.csv")),
    rt_collection_manipulate = I(list(function(df) {
      df |>
        mutate(
          speed = as.numeric(speed)
